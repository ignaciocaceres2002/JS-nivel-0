/*
    ...
    3. Realizar una página con un script que calcule el valor de la letra de un número de DNI (Documento
...
do {
    numero = window.prompt("Ingrese el numero de DNI");
    ...
    if(!isNaN(numero)) {
        ...
        if(numero > 0 && numero < 99999999) {
            ...
            alert("Por el resto " + resto + ", le corresponde la letra " + letra);

        }

        else {
            alert("Se admiten hasta 8 caracteres"); 
        }
